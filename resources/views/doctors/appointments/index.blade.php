...
@section('breadcrumbs')
    <p class="mb-0 text-white">Home / <a class="text-white" href="/appointments">Doctor Appointments</a> </p>
    <h3 class="mb-0 font-weight-bold text-white">Doctor Appointments</h3>
@endsection
...
@section('content')
        ...
        <div class="container-fluid">
            <h3 class="border-bottom pb-2">Doctor Appointments</h3>
