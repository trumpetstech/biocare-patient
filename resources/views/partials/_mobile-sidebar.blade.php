<div class="card mobile-sidebar-content d-print-none">
    <a href="#" style="font-size: 25px;" class="text-right mr-2 mt-3 text-secondary" @click.prevent="toggleSidebar()"><i class="fe-x"></i></a>
    ...
    <ul class="nav nav-pills flex-column" style="flex-wrap: nowrap">
        <li class="nav-item">
            <a href="/home" class="nav-link {{ isActive('home*') }}"><i class="fe-home mr-2"></i> Dashboard</a>
        </li>
        <li class="nav-item">
            <a href="/appointments" class="nav-link {{ isActive('appointments*') }}"><i class="fe-calendar mr-2"></i> Doctor Appointments</a>
        </li>
        <li class="nav-item">
            <a href="/consultations" class="nav-link {{ isActive('consultations*') }}"><i class="fe-list mr-2"></i> Consulted Doctors</a>
        </li>
        <li class="nav-item">
