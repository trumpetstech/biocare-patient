...
<div class="container-fluid">
       ...
       <h4 class="mb-1 mt-0">Pharmacy Payments</h4>
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                <ul class="nav tabs nav-pills navtab-bg nav-justified">
                    <li class="nav-item">
                        <a class="nav-link" href="/payments/consulting">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/payments/lab">
                            ...
                            <table class="table m-0">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="/lab-appointments/{{  $payment->lab_appointment_id }}">{{  $payment->lab_appointment_id }}</a></td>
